...
type NoteDescriptionInputProps = InputProps<string> &
  Omit<ComponentProps<typeof Container>, 'value' | 'onChange'>

export const NoteDescriptionInput = ({
  value,
  onChange,
  ...rest
}: NoteDescriptionInputProps) => {
  ...
  return (
    <Wrapper>
      <PositionLabel>
        <FormSectionShyTitle>Description</FormSectionShyTitle>
      </PositionLabel>
      <Container
