...
The "Tasks" page has four subpages: "Tasks", "Upcoming", "Automation", and "Templates".

The "Tasks" subpage is a kanban board with four columns: backlog, todo, inProgress, and done. Users can filter tasks by project.

In the "Upcoming" subpage, tasks are grouped grouped by either a day or week(the user can select between days and weeks views). The user can drag and drop tasks between days or weeks.
