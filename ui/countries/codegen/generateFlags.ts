import { CountryCode, countryCodes } from '@increaser/utils/countries'
import { makeRecord } from '@increaser/utils/makeRecord'
import fs from 'fs'
import path from 'path'
import { capitalizeFirstLetter } from '@increaser/utils/capitalizeFirstLetter'
import { createTsFile } from '@increaser/codegen/utils/createTsFile'
...
const generateFlags = async () => {
  ...
  const generatedBy = '@increaser/ui/country/codegen/generateFlags.ts'
